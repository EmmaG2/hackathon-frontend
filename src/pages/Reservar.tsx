...
export function Reservar() {
  ...
  return (
    <div className="fixed inset-0 bg-cafe/40 flex items-end justify-center">
      <div className="w-full max-w-97.5 bg-crema border border-cafe/12 rounded-t-[28px] max-h-[90vh] overflow-y-auto">
        <div className="w-11 h-1 bg-boton-muted rounded-full mx-auto mt-2.5" />
        ...
        <div className="flex items-start justify-between px-4.5 pt-4 pb-2">
          ...
          <button onClick={() => navegar(-1)} className="text-cafe-atenuado text-[16px] mt-2.5">✕</button>
        </div>

        <div className="h-px bg-cafe/7 mx-0" />
        ...
        <div className="px-4.5 pt-4 pb-1 flex flex-col gap-5">
              ...
              {DIAS.map((dia) => {
                ...
                return (
                  <button
                    ...
                    className={`flex flex-col gap-0.5 items-center justify-center px-1.5 py-2.5 rounded-[14px] min-w-[52px] border transition-all ${
                      activo
          ...
          <div className="bg-white border border-cafe/12 rounded-[14px] p-3.5 flex flex-col gap-2">
        ...
        <div className="flex items-center justify-between px-4 pt-3 pb-6.5 border-t border-cafe/7 mt-4">
